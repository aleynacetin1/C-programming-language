...
Your program should output an integer value (1 or 2) depending on whether 
the fan should join line 1 (name has even number of letters) or line 2 (name has odd number of letters).
...
int main(void) {
    ...
    while(name[i]!='\0')
     i++;
     //Name has even numbers of letters :1
     //Name has odd  numbers of letters :2
     
     if(i%2==1)//Thats mean odd number
     printf("2");
     
     else//Thats mean even number
     printf("1");
